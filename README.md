...
- 🔮 **Kotlin/2.3**: `Ktor Client`, `Ktor Server`, `kotlinx.coroutines`, `kotlinx.serialization`, `kotlinx.io`
- ☕ **Java/25**: `OOP`, `EOP`, `Multi-threading`, `Loom (virtual threads)`, `Jigsaw (JPMS)`, `FFM API`, `Cryptography`.
...
- 📚 **Libraries**: `Retrofit`, `OkHttp`, `JOOQ`, `HikariCP`, `Jackson`, `ASM`, `ORMLite`, `Logback`.
- 🪲 **Testing**: `JUnit`, `kotlin-test`, `mockk`.
- 🛠️ **Dev-Ops**: `Docker`, `Github Actions`, `Linux Server`, `Bash`, `Batch`.
